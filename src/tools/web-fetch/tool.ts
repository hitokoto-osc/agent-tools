...
export interface WebFetchOptions {
   ...
   */
  baseURL?: string;
  /** API key. Falls back to `OPENAI_API_KEY` env. Ignored when `model` is supplied. */
  apiKey?: string;
  /**
  ...
  /** Hard cap on tokens generated by the summariser. Provider default applies when omitted. */
